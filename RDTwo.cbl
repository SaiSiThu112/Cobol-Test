       ...
       PROCEDURE DIVISION.
           ...
           *> move today transaction data to today transaction working storage session
             ...
             COMPUTE WS-NEW-QUANTITY = WS-OLD-QUANTITY - WS-NEW-QUANTITY
                      DISPLAY WS-NEW-BRANCH-CODE WS-NEW-PRODUCT-CODE
                              WS-NEW-QUANTITY
                           ELSE
            COMPUTE  WS-NEW-QUANTITY = WS-OLD-QUANTITY + WS-NEW-QUANTITY
                      DISPLAY WS-NEW-BRANCH-CODE WS-NEW-PRODUCT-CODE
           ...
           CLOSE OLD-BALANCE-FILE.
            OPEN EXTEND NEW-BALANCE-FILE.
               MOVE NEW-BRANCH-CODE TO OUTPUT-BRANCH-CODE
               MOVE NEW-PRODUCT-CODE TO OUTPUT-PRODUCT-CODE
               MOVE NEW-QUANTITY TO OUTPUT-QUANTITY
               WRITE OUTPUTFILE
           END-WRITE.
           STOP RUN.
